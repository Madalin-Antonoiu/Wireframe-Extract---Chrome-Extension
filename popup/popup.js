...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    document.querySelector("#replaceText").addEventListener("click", replaceText)
    document.querySelector("#replaceImages").addEventListener("click", replaceImages)
});
...
function replaceText() {
    ...
    //1. Notify the Bg script who will inject the code
    console.log("Sending message to Bg script.");
